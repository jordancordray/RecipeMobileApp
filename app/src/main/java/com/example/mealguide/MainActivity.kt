...
import com.example.mealguide.ui.theme.OuterSpace
...
fun Navigation(navController : NavHostController) {
    ...
    NavHost(
        ...
        composable(route = "day/{dayName}",
            ...
            DayScreen(dayName, navController)
        }
...
@Composable
fun HomeScreen( navController : NavController, dayViewModel: DayViewModel = viewModel()){
...
@Composable
fun DayScreen(day: String, navController: NavController,
...
@Composable
fun ShoppingScreen(){
    Text("Shopping List", modifier = Modifier.padding(50.dp))
}
